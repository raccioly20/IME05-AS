...
```{r}
library(MASS)
leuc.exp.sel <- stepAIC(leuc.exp.comp, direction="backward")
...
```{r}
leuc.wei.sel <- stepAIC(leuc.wei.comp, direction="backward")
...
```{r}
leuc.logn.sel <- stepAIC(leuc.logn.comp, direction="backward")
...
```{r}
leuc.logl.sel <- stepAIC(leuc.logl.comp, direction="backward")
